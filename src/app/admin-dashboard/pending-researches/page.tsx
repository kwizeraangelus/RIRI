...
export default function PendingPublicationsPage() {
  ...
  const handleApprove = async (id: number) => {
    ...
    try {
      const res = await fetch(getApiUrl(`/api/admin/publications/${id}/approve/`), {
        method: 'POST',
        credentials: 'include',
      });
  ...
  const handleReject = async (id: number) => {
    ...
    try {
      const res = await fetch(getApiUrl(`/api/admin/publications/${id}/reject/`), {
        method: 'POST',
        credentials: 'include',
  ...
  const handleDelete = async (id: number, title: string) => {
    ...
    try {
      const res = await fetch(getApiUrl(`/api/admin/publications/${id}/`), {
        method: 'DELETE',
        credentials: 'include',
      });
