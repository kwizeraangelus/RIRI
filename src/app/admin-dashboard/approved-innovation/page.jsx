...
export default function ApprovedInnovations() {
  ...
  const fetchApprovedInnovations = async () => {
    setLoading(true);
    try {
      const res = await fetch(getApiUrl('/api/admin/innovations/approved/'), {
        credentials: 'include'
      });
      if (res.ok) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const res = await fetch(getApiUrl(`/api/admin/innovations/${editingInnovation.id}/update/`), {
        method: 'PUT',
        credentials: 'include',
        body: updateData
      });
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      const res = await fetch(getApiUrl(`/api/admin/innovations/${id}/delete/`), {
        method: 'DELETE',
        credentials: 'include'
      });
