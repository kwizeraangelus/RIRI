...
export default function PendingInnovationsPage() {
  ...
  const fetchPendingInnovations = async () => {
    ...
    try {
      const res = await fetch(getApiUrl('/api/admin/innovations/pending/'), {
        //credentials: 'include'
  ...
  const handleApprove = async (id) => {
    ...
    try {
      const res = await fetch(getApiUrl(`/api/admin/innovations/${id}/approve/`), {
        method: 'POST',
       // credentials: 'include'
        headers: { 'Authorization': `Bearer ${token}`},
      });
  ...
  const handleReject = async (id) => {
    ...
    try {
      const res = await fetch(getApiUrl(`/api/admin/innovations/${id}/reject/`), {
        method: 'POST',
       // credentials: 'include',
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      const res = await fetch(getApiUrl(`/api/admin/innovations/${id}/`), {
        method: 'DELETE',
       // credentials: 'include'
        headers: {'Authorization': `Bearer ${token}`},
      });
