...
const AboutPage = () => {
  const teamMembers = [
    ...
    { name: 'Dr. Lindagato Philemon', role: 'Director', email: 'mclaire@riri.gov.rw' },
      ...
      <section className="py-10 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-20">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
              <div className="bg-gradient-to-r from-[#050A14] to-[#1a237e] p-8 text-center">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">Leadership Team</h2>
