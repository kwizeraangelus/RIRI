...
@Module({
  imports: [
    ...
    JwtModule.register({ secret: process.env.JWT_SECRET || 'super-secret-key-change-this-in-production-very-long-random-string-987654321'  }), // Same secret as AuthService
  ],
